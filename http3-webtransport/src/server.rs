...
use http3_rs::webtransport::SessionId;
...
///
/// Similar to [`http3_rs::server::Connection`](https://docs.rs/http3-rs/latest/http3_rs/server/struct.Connection.html), it is generic over the QUIC implementation and buffer type.
    ...
    B: Buf,
{
    ...
    pub async fn accept(
        ...
        // Establishing a WebTransport session without the required HTTP/3 settings is a mistake.
